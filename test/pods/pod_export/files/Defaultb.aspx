 ...
 * REE 9/28/15 - Changed Jumbotron Free Demo to Free Setup button.
*/
</script>
...
.yellow-bg h2 {color:#fff;}
    ...
    <script>
        ...
        $(function () {
            ...
            $('#btnFreeSetup').on('click', function () {
                ga('send', 'event', 'Jumbotron', 'click', 'Jumbotron Free Setup');
            });
						...
						<div class="col-md-3 visible-md visible-lg ">
							...
							<div class="header-left clearfix">
								...
								<div class="logo smooth-scroll">
									<a href="#header-top">
										<img src="http://tix.com/Clients/TixNew/images/TixLogo512InverseDropShadow.png" alt="tix" />
									</a>
								</div>
						...
						<div class="col-xs-3 visible-xs visible-sm">
							...
							<div class="header-left clearfix">
								...
								<div class="logo smooth-scroll">
									<a href="#header-top">
									<br />
										<img src="http://tix.com/Clients/TixNew/images/TixLogo512InverseDropShadow.png" width="10%" alt="tix" />
									</a>
			...
			<div class="banner">
				...
				<div class="jumbotron  background-image">
					<div class="container text-center">
						...
						<a id="btnFreeSetup" href="" class="btn btn-lg btn-demo openModal" data-toggle="modal" data-id="priority3" data-target="#emailModal" >Free Setup</a>
					</div>
				</div>
								...
								<div class="modal-content">
									...
									<div class="modal-header bg-primary">
										...
										<h4 class="modal-title" style="color: #ffffff;">
											...
											<span class="priority3Item">Free Setup</span>
										</h4>
									</div>
									...
									<div class="modal-body">
										...
										<div class="form-horizontal" id="formCustomerInfor">
											...
											<span class="priority1Item">
                                                ...
                                                If you have a question about tickets you purchased, <a class="formCustomerServiceLink" href="mailto://customerservice@tix.com">click here.</a><br /><br />
											</span>
